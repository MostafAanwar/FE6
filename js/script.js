...
$.getJSON(
  "https://api.pokemontcg.io/v1/cards?supertype=pokemon",
  function (data) {
    var card; //variable to save the card of the pokemon
    var pokeName; //variable to save the name of the pokemon
    var type; //variable to save the type of the pokemon
    var hp; //variable to save the health of the pokemon
    var weaknesses; //variable to save which type of pokemon it is weak against
    //i is variable to get a random number to get random pokemon every time
